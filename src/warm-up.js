...
var shouldOrderMore;
//  if (inStock < 20) {
//    shouldOrderMore = "We need to order more"
//  } else {
//    shouldOrderMore = "We have plenty"
//  }
...
// if (stockCount >= 1)  {
//  willIEat = `I'm going to eat some ${food}!`
// } else {
//  willIEat = `We need to get some more ${food}.`
// }
// console.log(willIEat);
...
if (isFavorite === true) {
  favoriteFood = `My favorite food is ${food}!`
} else {
  favoriteFood = `I recently ate ${food}.`
}
...
var vegetables = ['Broccoli', 'Carrot', 'Asparagus', 'Peas', 'Corn'];
...
var fruits = ['Apple', 'Banana', 'Pear', 'Plum', 'Kiwi', 'Tomato', 'Strawberry'];
...
// Other key values could be address, hours, delivery
